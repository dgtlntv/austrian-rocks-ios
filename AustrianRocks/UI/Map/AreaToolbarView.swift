            ...
            ScrollView(.horizontal, showsIndicators: false) {
                HStack(alignment: .center, spacing: 8) {
                    ...
                    Button {
                        ...
                        .background(mapState.filters.gradeRange != nil ? Color.appBrandColor : Color(UIColor.systemBackground))
                        .cornerRadius(32)
                    }
                    ...
                    Button {
                        ...
                        .background(mapState.filters.popular ? Color.appBrandColor : Color(UIColor.systemBackground))
                        .cornerRadius(32)
                    }
                    ...
                    Button {
                        ...
                        .background(mapState.filters.favorite ? Color.appBrandColor : Color(UIColor.systemBackground))
                        .cornerRadius(32)
                    }
                    ...
                    Button {
                        ...
                        .background(mapState.filters.ticked ? Color.appBrandColor : Color(UIColor.systemBackground))
                        .cornerRadius(32)
                    }
