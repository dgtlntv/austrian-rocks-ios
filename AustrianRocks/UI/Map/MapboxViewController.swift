...
class MapboxViewController: UIViewController {
    ...
    override public func viewDidLoad() {
        ...
        let cameraOptions = CameraOptions(
            center: CLLocationCoordinate2D(latitude: 47.7, longitude: 13.5),
            zoom: 7.0
        )
    ...
    func addSources() {
        ...
        problems.url = BrandConfig.Mapbox.problemsTilesetURL
    ...
    func addLayers() {
        ...
        // Uniform gray color for all problems
        problemsLayer.circleColor = .constant(StyleColor(UIColor(red: 135/255, green: 138/255, blue: 141/255, alpha: 1.0)))
